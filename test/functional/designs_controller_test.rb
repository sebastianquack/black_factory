...
class DesignsControllerTest < ActionController::TestCase
  ...
  test "should create design" do
    assert_difference('Design.count') do
      post :create, design: { challenge_id: @design.challenge_id, description: @design.description, name: @design.name }
    end
  ...
  test "should update design" do
    put :update, id: @design, design: { challenge_id: @design.challenge_id, description: @design.description, name: @design.name }
    assert_redirected_to design_path(assigns(:design))
  end
